            ...
            <div class="row justify-content-center">
                <div class="col-12">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-md-9 text-left text-xl text-uppercase">
                                    <h2 class="mb-2">
                                    <span class="fe fe-info mr-2"></span>
                                    Liste Tâches Encours</h2>
                                </div>
                                <div class="col-md-3 text-right" style="font-family: Century Gothic;">
                                    @can('creer-tache')
                                        @if($number_incident)
                                        <button 
                                                id="toto"

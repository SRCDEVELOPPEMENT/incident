...
$('#citadelle').change(function() {
    ...
    if ($(this).val()) {
        if ($(this).val() == "dg") {
            ...
            $('.tout_ta_fait').replaceWith(`
                <span style="font-size:3em;" class="mb-0 tout_ta_fait">
                ${incidentSiteSelectionne.length < 10 ? 0 +""+ incidentSiteSelectionne.length : incidentSiteSelectionne.length}
                </span>
            `);

            $('.cliotu').replaceWith(`<h1 style="font-size:3em;" class="text-success mb-0 cliotu">${cls < 10 ? 0 +""+ cls : cls}</h1>`);
            $('.encourgiant').replaceWith(`<h1 style="font-size:3em;" class="text-primary mb-0 encourgiant">${ens < 10 ? 0 +""+ ens : ens}</h1>`);
            $('.annulegiant').replaceWith(`<h1 style="font-size:3em;" class="mb-0 annulegiant">${ann < 10 ? 0 +""+ ann : ann}</h1>`)
        ...
        $('.tout_ta_fait').replaceWith(`
            <span style="font-size:3em;" class="mb-0 tout_ta_fait">
            ${tab.length < 10 ? 0 +""+ tab.length : tab.length}
            </span>
        `);
...
$('#regionnn').change(function() {
    ...
    if ($(this).val()) {
        ...
        $('.tout_ta_fait').replaceWith(`
            <span style="font-size:3em;" class="mb-0 tout_ta_fait">
            ${incidentRegionSelectionne.length < 10 ? 0 +""+ incidentRegionSelectionne.length : incidentRegionSelectionne.length}
            </span>
        `);
...
$(document).on("change", "#DateDebut", function() {
    ...
    if ($(this).val()) {
        ...
        if ($('#citadelle').val()) {
            ...
            $('.tout_ta_fait').replaceWith(`<span style="font-size:3em;" class="mb-0 tout_ta_fait">
                ${incidentDateSelectionne.length < 10 ? 0 +""+ incidentDateSelectionne.length : incidentDateSelectionne.length}
            </span>`);
